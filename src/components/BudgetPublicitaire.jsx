    ...
    <div className="card mt-2">
      ...
      >
        ...
        <div className="text-center">
          <p>
          {ventesNecessaires.toFixed(2)} ventes  x {panierMoyen}€ (Panier moyen) = {caResultant.toFixed(2)}€ 
          </p>
        </div>
        <div className="text-center">
          <p>
          ...
          <p>Ce budget publicitaire est mensuel si vous souhaité réaliser {profitSouhaite}€ de bénéfices chaque mois. </p>
        </div>
        </div>
      </div>
      {/* end détails calculs */}
